...
for (i = 0; i <= snowMax; i++) { 
 document.write("<span id='flake" + i + "' style='" + snowStyles + "position:absolute;top:-" + screen + "'>" + snowEntity + "</span>"); 
} 
...
const header1 = document.createElement('header1' )
...
good.addEventListener('dblclick', ()=>{
